...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (a, b) -> Integer.compare(b, a);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(Comparator.comparingInt(Customer::getBudget).reversed()).limit(3).map(Customer::getName);
